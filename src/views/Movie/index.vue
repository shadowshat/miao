...
.movie_menu .hot_swtich{ display: flex; height:100%; line-height: 45px;cursor: pointer;}
...
.movie_menu .search_entry{ margin-right:20px; height:100%; line-height: 45px;cursor: pointer;}
